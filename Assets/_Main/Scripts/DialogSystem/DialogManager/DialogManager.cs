...
public class DialogManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (dialogUI == null)
        {
            ...
            if (dialogUI == null)
                dialogUI = FindObjectOfType<DialogUI>(true);
        }
    ...
    private void BuildSequenceLookup()
    {
        ...
        if (registeredSequences == null || registeredSequences.Length == 0)
            registeredSequences = Resources.LoadAll<DialogSequence>("DialogSequence");
