...
public static class DialoguesNames
{
	...
	public const string Area1_PlayerOpening_Raline = "Area1-Opening-Raline";
	public const string Area2_Gavi = "Area2-Gavi";
	public const string Area2_Raline = "Area2-Raline";
	...
	public const string Map3_Gavi = "Map3-Gavi";
	public const string Map3_Raline = "Map3-Raline";
	public const string Map4_dialogue1_Gavi = "Map4-dialogue1-Gavi";
	public const string Map4_dialogue1_Raline = "Map4-dialogue1-Raline";
	public const string Map4_Dialogue2 = "Map4-Dialogue2";
	public const string MapEpilogue_Gavi = "MapEpilogue-Gavi";
	public const string MapEpilogue_Raline = "MapEpilogue-Raline";
