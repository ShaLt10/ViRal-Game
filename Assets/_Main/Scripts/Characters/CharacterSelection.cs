...
public class CharacterSelection : MonoBehaviour
{
    ...
    [SerializeField] private GameObject selectionRoot;   // tombol Raline/Gavi
    ...
    private void OnConfirmYes()
    {
        ...
        if (!string.IsNullOrEmpty(gameScene)) SceneFlow.LoadScene(gameScene);
    ...
    private void SetChoiceLabelsVisible(bool visible)
    {
        ...
        Transform gaviLabel = gaviButton ? gaviButton.transform.Find("ChoiceLabel") : null;
        if (ralineLabel) ralineLabel.gameObject.SetActive(visible);
        if (gaviLabel) gaviLabel.gameObject.SetActive(visible);
    }
