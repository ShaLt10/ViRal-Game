...
namespace MoreMountains.TopDownEngine
{
	...
	public class SavedData{
		...
		public SavedData() { }
		public SavedData(int _point, int _unlockedLevel)
        {
			Point = _point;
		...
		MMEventListener<TopDownEnginePointEvent>
	{
        ...
        {
			SavedData data = new SavedData(Points,UnlockedLevel);
			MMSaveLoadManager.Save(data,"SaveData.sav");
        }

		public void LoadGame()
        {
			SavedData data = new SavedData();
			data = (SavedData)MMSaveLoadManager.Load(typeof(SavedData), "SaveData.sav");
